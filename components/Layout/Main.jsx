  ...
  return (
    <section className='flex justify-between'>
      <div className='flex flex-no-wrap'>
        ...
        <div className='w-64 absolute sm:relative bg-gray-800 shadowh-full flex-col justify-between hidden sm:flex'>
          <div className='px-8'>
        ...
        {/* Sidebar ends */}
        <div className='flex items-center max-h-[90%] justify-center px-4'>
